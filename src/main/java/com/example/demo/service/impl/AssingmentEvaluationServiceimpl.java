...
public class AssignmentEvaluationServiceImpl implements AssignmentEvaluationService {
    ...
    @Override
    public List<AssignmentEvaluationRecord> getEvaluationsForVolunteer(Long volunteerId) {
        return assignmentEvaluationRecordRepository.findByAssignment_Volunteer_Id(volunteerId);
    }
}